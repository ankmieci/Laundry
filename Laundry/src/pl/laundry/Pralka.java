...
public abstract class Pralka {
	...
	public void setTemp(double temp) throws ValueOutOfRangeException {
		if (temp >= 0 && temp <= 90) {
			...
			this.temp = temp;
			System.out.println("Temperatura prania: " + temp + "\u00b0C"); // unicode
		} else {
	...
	public void tempUp() {
		if (temp <= 89.5) {
			...
			System.out.println("Przekroczony zakres. Nie mozna podniesc temperatury prania");
		}
	}
	...
	public void tempDown() {
		if (temp >= 0.5) {
			...
			System.out.println("Przekroczony zakres. Nie mozna obnizyc temperatury prania");
		}
	}
